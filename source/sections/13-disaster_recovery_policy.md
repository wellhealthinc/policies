...
The Well Contingency Plan establishes procedures to recover Well following a disruption resulting from a disaster. This Disaster Recovery Policy is maintained by the Well Security Officer and Privacy Officer.
...
2. Identify the activities, resources, and procedures needed to carry out Well processing requirements during prolonged interruptions to normal operations.
3. Identify and define the impact of interruptions to Well systems.
4. Assign responsibilities to designated personnel and provide guidance for recovering Well during prolonged periods of interruption to normal operations.
5. Ensure coordination with other Well staff who will participate in the contingency planning strategies.
6. Ensure coordination with external points of contact and vendors who will participate in the contingency planning strategies.

This Well Contingency Plan has been developed as required under the Office of Management and Budget (OMB) Circular A-130, Management of Federal Information Resources, Appendix III, November 2000, and the Health Insurance Portability and Accountability Act (HIPAA) Final Security Rule, Section §164.308(a)(7), which requires the establishment and implementation of procedures for responding to events that damage systems containing electronic protected health information.
...
The Well Contingency Plan also complies with the following federal and departmental policies:
...
Well defined two categories of systems from a disaster recovery perspective.
...
1. The **Ops Team** is responsible for recovery of the Well hosted environment, network devices, and all servers. Members of the team include personnel who are also responsible for the daily operations and maintenance of Well. The team leader is the CTO and directs the Dev Ops Team.
...
This phase addresses the initial actions taken to detect and assess damage inflicted by a disruption to Well. Based on the assessment of the Event, sometimes according to the Well Incident Response Policy, the Contingency Plan may be activated by either the CTO.
...
* The Well Contingency Plan is to be activated if one or more of the following criteria are met:
  * Well will be unavailable for more than 48 hours.
  * Hosting facility is damaged and will be unavailable for more than 24 hours.
  * Other criteria, as appropriate and as defined by Well.
...
The following procedures are for recovering the Well infrastructure at the alternate site. Procedures are outlined per team required. Each procedure should be executed in the sequence it is presented to maintain efficient operations.

Recovery Goal: The goal is to rebuild Well infrastructure to a production state.
...
This section discusses activities necessary for restoring Well operations at the original or new site. The goal is to restore full operations within 24 hours of a disaster or outage. When the hosted data center at the original or new site has been restored, Well operations at the alternate site may be transitioned back. The goal is to provide a seamless transition of operations from the alternate site to the computer center.
...
2. Plan Deactivation
   * If the Well environment is moved back to the original site from the alternative site, all hardware used at the alternate site should be handled and disposed of according to the Well Media Disposal Policy.
